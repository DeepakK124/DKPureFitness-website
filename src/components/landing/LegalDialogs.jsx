      ...
      <DialogContent className="max-w-3xl max-h-[80vh] overflow-y-auto bg-card border-border text-muted-foreground p-6 md:p-8 shadow-xl">
        ...
        <div className="space-y-6 md:space-y-8 font-body leading-relaxed text-xs md:text-sm mt-4">
          ...
          <section>
            ...
            <p className="text-primary font-medium"><strong>The content on this website (including workouts, nutrition, and transformation stories) is for informational purposes only and is not a substitute for professional medical advice, diagnosis, or treatment.</strong></p>
          ...
          <section>
            ...
            <div className="space-y-3">
              ...
              <p><strong>2.2 Acceptance:</strong> {GYM_NAME} reserves the right to refuse membership to anyone violating these terms or gym policies.</p>
            </div>
          </section>
          ...
          <section>
            ...
            <p>All logos, trademarks, images, and content on this website are the property of {GYM_NAME} or its licensors. You may not copy, distribute, or use this content without explicit written permission. You agree not to use the website for any unlawful purpose or to submit false/spam inquiries.</p>
          </section>
    ...
    <Dialog>
      ...
      <DialogContent className="max-w-3xl max-h-[80vh] overflow-y-auto bg-card border-border text-muted-foreground p-6 md:p-8 shadow-xl">
        ...
        <div className="space-y-6 md:space-y-8 font-body leading-relaxed text-xs md:text-sm mt-4">
          <section>
            <p>
              At {GYM_NAME}, we respect your privacy and are committed to protecting your personal data in compliance with the Digital Personal Data Protection Act (DPDPA) and the Information Technology Rules of India.
            </p>
          </section>
          ...
          <section>
            <h2 className="text-foreground text-base md:text-lg font-semibold mb-3 md:mb-4 uppercase tracking-wider border-b border-border pb-1">3. Data Sharing & Security</h2>
          ...
          <section>
            <h2 className="text-foreground text-base md:text-lg font-semibold mb-3 md:mb-4 uppercase tracking-wider border-b border-border pb-1">4. Your Rights (Withdrawal of Consent)</h2>
          ...
          <section>
            <div className="bg-secondary/30 border border-border p-4 space-y-2 mt-6">
              <h3 className="text-foreground font-display text-sm uppercase">5. Grievance Officer</h3>
